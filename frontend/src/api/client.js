...
export async function getEngagementGoals(engagementId) {
  return apiRequest(`/workflow/${engagementId}/goals`);
}
...
export async function deleteEngagementGoal(engagementId, goalId) {
  return apiRequest(`/workflow/${engagementId}/goals/${goalId}`, {
    method: 'DELETE',
  });
}
...
export async function getEngagementRoles(engagementId) {
  return apiRequest(`/workflow/${engagementId}/roles`);
}
...
export async function getPreparationItems(engagementId) {
  return apiRequest(`/workflow/${engagementId}/preparation`);
}
...
export async function updatePreparationItem(engagementId, itemId, data) {
  return apiRequest(`/workflow/${engagementId}/preparation/${itemId}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  });
}
...
export async function getTargetSystems(engagementId) {
  return apiRequest(`/workflow/${engagementId}/targets`);
}
...
export async function deleteTargetSystem(engagementId, targetId) {
  return apiRequest(`/workflow/${engagementId}/targets/${targetId}`, {
    method: 'DELETE',
  });
}
...
export async function getAttackInfrastructure(engagementId) {
  return apiRequest(`/workflow/${engagementId}/infrastructure`);
}
...
export async function deleteAttackInfrastructure(engagementId, infraId) {
  return apiRequest(`/workflow/${engagementId}/infrastructure/${infraId}`, {
    method: 'DELETE',
  });
}
...
export async function generateDocument(engagementId, documentType) {
  // Map document types to specific endpoints
  const typeToEndpoint = {
    'plan': 'plan',
    'executive_report': 'executive-report',
    'technical_report': 'technical-report'
  };
  const endpoint = typeToEndpoint[documentType] || documentType;
  return apiRequest(`/documents/${engagementId}/${endpoint}/generate`, {
    method: 'POST',
  });
}
...
export async function getActionItems(engagementId, filters = {}) {
  ...
  const queryString = params.toString();
  return apiRequest(`/action-items/${engagementId}${queryString ? `?${queryString}` : ''}`);
}

export async function createActionItem(engagementId, data) {
  return apiRequest(`/action-items/${engagementId}`, {
    method: 'POST',
    body: JSON.stringify(data),
  });
}
