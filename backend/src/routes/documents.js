...
router.post('/:id/executive-report/generate', verifyEngagementAccess, async (req, res) => {
  try {
    ...
    // Gather data and generate (placeholder - implement generateExecutiveReport)
    ...
    // For now, generate a simple plan-style document with stats
    // In production, implement a proper executive report generator
    const buffer = await generatePlanDocument(data);
...
router.post('/:id/technical-report/generate', verifyEngagementAccess, async (req, res) => {
  try {
    ...
    // Placeholder - implement generateTechnicalReport
    const buffer = await generatePlanDocument(data);
